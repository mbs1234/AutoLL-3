...
attached to the
[release](https://github.com/mbs1234/AutoLL-3/releases/tag/autoll3-v1.2.7)
...
```bash
gh workflow run deploy.yml --ref autoll3-v1.2.7
```
...
suite — 117 suites, 1688 tests — and if either fails, the publish is skipped and
